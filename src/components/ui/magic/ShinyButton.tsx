...
const ShinyButton = ({ children, className, href, target, ...props }: ShinyButtonProps) => {
  return (
      ...
      >
        <span
          className="relative flex justify-center items-center size-full text-sm uppercase tracking-wide text-blanco dark:font-light dark:text-[rgb(255,255,255,90%)]"
          style={{
            maskImage:
